...
public class GameManager : MonoBehaviour {
	...
	public GameObject previousLevelButtons;
	...
	void Start () {
		...
		// inactivate the previousLevelButtons gameObject, if it is set
		if (previousLevelButtons)
			previousLevelButtons.SetActive (false);
	...
	void EndGame() {
		...
		// activate the playAgainButtons gameObject, if it is set 
		if (previousLevelButtons)
			previousLevelButtons.SetActive (true);
